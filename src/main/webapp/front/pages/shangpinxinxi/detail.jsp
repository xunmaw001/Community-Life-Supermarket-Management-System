				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>供应商账号：</span>
							<span class="desc">
								{{detail.gongyingshangzhanghao}}
							</span>
						</div>
																								<div class="detail-item">
							<span>供应商名称：</span>
							<span class="desc">
								{{detail.gongyingshangmingcheng}}
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shangpinxinxi','进货')" @click="onAcrossTap('shangpinjinhuo')" type="button" class="layui-btn">
								进货
							</button>
																					<button v-if="isAuth('shangpinxinxi','退货')" @click="onAcrossTap('shangpintuihuo')" type="button" class="layui-btn">
								退货
							</button>
																					<button v-if="isAuth('shangpinxinxi','出库')" @click="onAcrossTap('xiaoshouchuku')" type="button" class="layui-btn">
								出库
							</button>
																					<button v-if="isAuth('shangpinxinxi','购买')" @click="onAcrossTap('shangpindingdan')" type="button" class="layui-btn">
								购买
							</button>
