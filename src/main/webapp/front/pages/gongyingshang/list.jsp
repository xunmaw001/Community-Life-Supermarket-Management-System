        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">供应商展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="gongyingshangmingcheng" id="gongyingshangmingcheng" placeholder="供应商名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">负责人姓名</label>
                <div class="layui-input-inline">
                  <input type="text" name="fuzerenxingming" id="fuzerenxingming" placeholder="负责人姓名" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('gongyingshang','新增')" @click="jump('../gongyingshang/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../gongyingshang/detail.jsp?id='+item.id)">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#gongyingshangmingcheng').val()) {
          param['gongyingshangmingcheng'] = jquery('#gongyingshangmingcheng').val() ? '%' + jquery('#gongyingshangmingcheng').val() + '%' : '';
        }  
        if (jquery('#fuzerenxingming').val()) {
          param['fuzerenxingming'] = jquery('#fuzerenxingming').val() ? '%' + jquery('#fuzerenxingming').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('gongyingshang/list', 'get', param, function(res) {
