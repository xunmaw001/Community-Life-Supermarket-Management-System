		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.songhuodizhi" type="text" name="songhuodizhi" id="songhuodizhi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">添加时间：</label>
						<div class="layui-input-block">
							<input type="text" name="tianjiashijian" id="tianjiashijian" autocomplete="off" class="layui-input">
						</div>
					</div>
		...
		<script>
			...
			var vue = new Vue({
                ...
                computed: {
                                                                                                                                                                                                                                                                                                            zongjiage:{
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    get: function () {
                        return 1*this.detail.shangpinjiage*this.detail.shuliang
                    }
                    },
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            },
				methods: {
