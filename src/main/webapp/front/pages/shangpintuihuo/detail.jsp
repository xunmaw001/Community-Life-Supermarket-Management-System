				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>退换单价：</span>
							<span class="desc">
								{{detail.tuihuandanjia}}
							</span>
						</div>
																								<div class="detail-item">
							<span>退换总价：</span>
							<span class="desc">
								{{detail.tuihuanzongjia}}
							</span>
						</div>
																								<div class="detail-item">
							<span>退换时间：</span>
							<span class="desc">
								{{detail.tuihuanshijian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>供应商账号：</span>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shangpintuihuo`);
