...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">商品进货管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>商品进货列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品进货列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jinhuobianhao')">进货编号<i id="jinhuobianhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('jinhuodanjia')">进货单价<i id="jinhuodanjiaIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jinhuozongjiage')">进货总价格<i id="jinhuozongjiageIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jinhuoshijian')">进货时间<i id="jinhuoshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jinhuobianhaoCell  = document.createElement('td');

						 jinhuobianhaoCell.innerHTML = item.jinhuobianhao;


			row.appendChild(jinhuobianhaoCell);
			...
			var jinhuodanjiaCell  = document.createElement('td');

						 jinhuodanjiaCell.innerHTML = item.jinhuodanjia;


			row.appendChild(jinhuodanjiaCell);
			var jinhuozongjiageCell  = document.createElement('td');

						 jinhuozongjiageCell.innerHTML = item.jinhuozongjiage;


			row.appendChild(jinhuozongjiageCell);
			var jinhuoshijianCell  = document.createElement('td');

						  jinhuoshijianCell.innerHTML = item.jinhuoshijian;


			row.appendChild(jinhuoshijianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangpinjinhuo/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shangpinjinhuo");
