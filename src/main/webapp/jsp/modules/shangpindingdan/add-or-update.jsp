...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>商品订单管理</span></li>
								<li class="breadcrumb-item active"><span>编辑商品订单</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>商品价格</label>
										<input id="shangpinjiage" name="shangpinjiage" class="form-control" onchange="calculation()">
									</div>
									<div class="form-group col-md-6">
										<label>数量</label>
									...
									<div class="form-group col-md-6">
										<label>送货地址</label>
										<input id="songhuodizhi" name="songhuodizhi" class="form-control" placeholder="送货地址">
									</div>
									<div class="form-group col-md-6">
										<label>添加时间</label>
	...
	<script>
		...
		function calculation(){
			...
			var y = 0;
			var flag = 0;
			if($("#shangpinjiage").val() != null && $("#shangpinjiage").val() != ""){
				if(x == 0 && flag < 2){
					x = (x+1) * parseFloat($("#shangpinjiage").val());
					flag++;
				}else{
					x = x * parseFloat($("#shangpinjiage").val());
					flag++;
				}
			}
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.songhuodizhi != null && res.data.songhuodizhi != ''){
							$('#songhuodizhi').val(res.data.songhuodizhi)
						}
						$(validform());
					}
				});
		...
		function dataBind(){
			...
			$("#songhuodizhi").val(ruleForm.songhuodizhi);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.songhuodizhi != null && res.data.songhuodizhi != ''){
