...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>商品订单列表</span></li>
							</ol>
						</div>
					</div>
				</div>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('songhuodizhi')">送货地址<i id="songhuodizhiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var songhuodizhiCell  = document.createElement('td');

						 songhuodizhiCell.innerHTML = item.songhuodizhi;


			row.appendChild(songhuodizhiCell);
		...
		function sh(){
			...
			httpJson("shangpindingdan/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangpindingdan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shangpindingdan");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"shangpindingdan");
