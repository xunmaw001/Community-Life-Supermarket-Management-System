...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">商品盘点管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>商品盘点列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品盘点列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('pandianshijian')">盘点时间<i id="pandianshijianIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('shidianshuliang')">实点数量<i id="shidianshuliangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shifouquehuo')">是否缺货<i id="shifouquehuoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shifouqueshao')">是否缺少<i id="shifouqueshaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var pandianshijianCell  = document.createElement('td');

						  pandianshijianCell.innerHTML = item.pandianshijian;


			row.appendChild(pandianshijianCell);
			...
			var shidianshuliangCell  = document.createElement('td');

						 shidianshuliangCell.innerHTML = item.shidianshuliang;


			row.appendChild(shidianshuliangCell);
			var shifouquehuoCell  = document.createElement('td');

						  shifouquehuoCell.innerHTML = item.shifouquehuo; 

			row.appendChild(shifouquehuoCell);
			var shifouqueshaoCell  = document.createElement('td');

						  shifouqueshaoCell.innerHTML = item.shifouqueshao; 

			row.appendChild(shifouqueshaoCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangpinpandian/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shangpinpandian");
