...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑供应商商品</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>供应商商品管理</span></li>
								<li class="breadcrumb-item active"><span>编辑供应商商品</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">供应商商品信息</h3>
	...
	<script>
		...
		var tableName = "gongyingshangshangpin";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "gongyingshangshangpin/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("gongyingshangshangpin/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("gongyingshangshangpin/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("gongyingshangshangpin"+colName,"GET",{
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.gongyingshangzhanghao != null && res.data.gongyingshangzhanghao != ''){
							$('#gongyingshangzhanghao').val(res.data.gongyingshangzhanghao)
						}
						if(res.data !=null && res.data.gongyingshangmingcheng != null && res.data.gongyingshangmingcheng != ''){
