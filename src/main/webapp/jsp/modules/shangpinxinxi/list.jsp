...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			crossBtn3.setAttribute("onclick","crossTable(" + item.id + ",\"xiaoshouchuku\")");
			if(crossBtnControl('出库') == true){
				btnGroup.appendChild(crossBtn3);
			}   
			var crossBtn4 = document.createElement('button');
            crossBtn4.innerHTML = "购买"
			crossBtn4.setAttribute("type","button");
			crossBtn4.setAttribute("class","btn btn-primary btn-sm");
			crossBtn4.setAttribute("onclick","crossTable(" + item.id + ",\"shangpindingdan\")");
			if(crossBtnControl('购买') == true){
				btnGroup.appendChild(crossBtn4);
			}   
			//详情按钮
