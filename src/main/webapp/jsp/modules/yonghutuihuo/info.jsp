...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="tuihuoshijian" name="tuihuoshijian" class="form-control" v-model="ruleForm.tuihuoshijian" readonly>
									</div>
									...
									<div class="form-group  col-md-12">
										<label>退货理由</label>
										<script id="tuihuoliyouEditor" type="text/plain" style="width:800px;height:230px;"></script>
										<script type="text/javascript">
										    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
										   //相见文档配置属于你自己的编译器
										 var tuihuoliyouUe = UE.getEditor('tuihuoliyouEditor', {
											toolbars: [
													[
														'undo', //撤销
														'bold', //加粗
										...
										<input type="hidden" name="tuihuoliyou" id="tuihuoliyou-input">
									</div>
									<div class="form-group  col-md-12">
										<label>审核回复</label>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
			if(ruleForm.tuihuoliyou != null && ruleForm.tuihuoliyou != 'null' && ruleForm.tuihuoliyou != ''){
				var mes = '' + ruleForm.tuihuoliyou;
				var tuihuoliyouUeditor = UE.getEditor('tuihuoliyouEditor');
				tuihuoliyouUeditor.ready(function() {
					tuihuoliyouUeditor.setContent(mes);
					tuihuoliyouUeditor.setDisabled('fullscreen');
				});
			}
