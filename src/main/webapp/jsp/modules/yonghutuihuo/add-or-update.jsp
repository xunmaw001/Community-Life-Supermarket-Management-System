		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑用户退货</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>用户退货管理</span></li>
								<li class="breadcrumb-item active"><span>编辑用户退货</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">用户退货信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>总价格</label>
										<input id="zongjiage" name="zongjiage" class="form-control" placeholder="总价格">
									</div>
									<div class="form-group col-md-6">
										<label>用户账号</label>
									...
									<div class="form-group col-md-6">
										<label>退货时间</label>
										<div id="tuihuoshijianDate" class="input-append date form_datetime">
											<input id="tuihuoshijian-input" name="tuihuoshijian" size="20" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>退货理由</label>
										<textarea name="tuihuoliyou" class="form-control" id="tuihuoliyou" rows="3"></textarea>
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yonghutuihuo/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yonghutuihuo/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yonghutuihuo/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#tuihuoshijianDate").datetimepicker({ 
				autoclose: true,
		...
		function calculationSE(colName){
			//单列求和接口
			http("yonghutuihuo"+colName,"GET",{
				tableName: "yonghutuihuo",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
		...
		function dataBind(){
			...
			$("#tuihuoshijian-input").val(ruleForm.tuihuoshijian);
			$("#tuihuoliyou").val(ruleForm.tuihuoliyou);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.tuihuoshijian != null && res.data.tuihuoshijian != ''){

					$("#tuihuoshijian-input").val(res.data.tuihuoshijian);
					$('#tuihuoshijianFileName').val(res.data.tuihuoshijian)
					}
					if(res.data != null && res.data != '' && res.data.tuihuoliyou != null && res.data.tuihuoliyou != ''){

					$("#tuihuoliyou").val(res.data.tuihuoliyou);
					}
