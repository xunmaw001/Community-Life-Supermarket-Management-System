...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">用户退货管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>用户退货列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">用户退货列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var tuihuoshijianCell  = document.createElement('td');

						  tuihuoshijianCell.innerHTML = item.tuihuoshijian;


			row.appendChild(tuihuoshijianCell);
			var tuihuoliyouCell  = document.createElement('td');

						  if(item.tuihuoliyou != null && item.tuihuoliyou != "" && item.tuihuoliyou.length >= 11){
			  	tuihuoliyouCell.innerHTML = item.tuihuoliyou.substring(0, 10) + "..."; 
			  }else{
			  	tuihuoliyouCell.innerHTML = item.tuihuoliyou;
			  }


			row.appendChild(tuihuoliyouCell);
		...
		function sh(){
			...
			httpJson("yonghutuihuo/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yonghutuihuo/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yonghutuihuo");
