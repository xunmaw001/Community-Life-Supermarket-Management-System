...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">销售出库管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>销售出库列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">销售出库列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chukubianhao')">出库编号<i id="chukubianhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('chukudanjia')">出库单价<i id="chukudanjiaIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('chukuzongjiage')">出库总价格<i id="chukuzongjiageIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('chukushijian')">出库时间<i id="chukushijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xiaoshouduixiang')">销售对象<i id="xiaoshouduixiangIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chukubianhaoCell  = document.createElement('td');

						 chukubianhaoCell.innerHTML = item.chukubianhao;


			row.appendChild(chukubianhaoCell);
			...
			var chukudanjiaCell  = document.createElement('td');

						 chukudanjiaCell.innerHTML = item.chukudanjia;


			row.appendChild(chukudanjiaCell);
			var chukuzongjiageCell  = document.createElement('td');

						 chukuzongjiageCell.innerHTML = item.chukuzongjiage;


			row.appendChild(chukuzongjiageCell);
			var chukushijianCell  = document.createElement('td');

						  chukushijianCell.innerHTML = item.chukushijian;


			row.appendChild(chukushijianCell);
			var xiaoshouduixiangCell  = document.createElement('td');

						 xiaoshouduixiangCell.innerHTML = item.xiaoshouduixiang;


			row.appendChild(xiaoshouduixiangCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xiaoshouchuku/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xiaoshouchuku");
