...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">商品退货管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>商品退货列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品退货列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="gongyingshangmingchengSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('tuihuanbianhao')">退换编号<i id="tuihuanbianhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('tuihuandanjia')">退换单价<i id="tuihuandanjiaIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('tuihuanzongjia')">退换总价<i id="tuihuanzongjiaIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('tuihuanshijian')">退换时间<i id="tuihuanshijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('gongyingshangzhanghao')">供应商账号<i id="gongyingshangzhanghaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var tuihuanbianhaoCell  = document.createElement('td');

						 tuihuanbianhaoCell.innerHTML = item.tuihuanbianhao;


			row.appendChild(tuihuanbianhaoCell);
			...
			var tuihuandanjiaCell  = document.createElement('td');

						 tuihuandanjiaCell.innerHTML = item.tuihuandanjia;


			row.appendChild(tuihuandanjiaCell);
			var tuihuanzongjiaCell  = document.createElement('td');

						 tuihuanzongjiaCell.innerHTML = item.tuihuanzongjia;


			row.appendChild(tuihuanzongjiaCell);
			var tuihuanshijianCell  = document.createElement('td');

						  tuihuanshijianCell.innerHTML = item.tuihuanshijian;


			row.appendChild(tuihuanshijianCell);
			var gongyingshangzhanghaoCell  = document.createElement('td');

						 gongyingshangzhanghaoCell.innerHTML = item.gongyingshangzhanghao;


			row.appendChild(gongyingshangzhanghaoCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shangpintuihuo/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shangpintuihuo");
