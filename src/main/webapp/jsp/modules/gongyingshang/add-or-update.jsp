					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>供应商管理</span></li>
								<li class="breadcrumb-item active"><span>编辑供应商</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "gongyingshang/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("gongyingshang/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function calculationSE(colName){
			//单列求和接口
			http("gongyingshang"+colName,"GET",{
