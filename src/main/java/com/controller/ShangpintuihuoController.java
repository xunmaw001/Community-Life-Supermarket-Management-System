...
public class ShangpintuihuoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShangpintuihuoEntity shangpintuihuo, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("gongyingshang")) {
			shangpintuihuo.setGongyingshangzhanghao((String)request.getSession().getAttribute("username"));
		}
